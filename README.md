...
В данной части задания были построены диаграммы Венна пересечения геномных областей (они показывают количество перекрытия пиками первого образца (первого файла, поступившего на вход команде) пиков второго). Здесь реплики сравнивались с пиками, которые приведены в ENCODE (версия генома hg38). Для анализа 


Различия в количестве пересечений можно объяснить тем, что для получения диаграмм Венна важно, какой образец берется за главный для сравнения.
